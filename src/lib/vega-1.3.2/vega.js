//MSN: wrap in IFE
//to snip from the globals reliance
;(function(){
    'use strict';
    //MSN: snag out require deps
    var d3 = require('d3')
        ,vg
        ;
      ...
      function encodeGroup(scene, def, parent, trans, request) {
        ...
        for (i=0, len=scene.items.length; i<len; ++i) {
          ...
          if (def.axes) {
            ...
            //MSN: I need to pass the context `this` in
    ...
    return vg;
    //MSN: pass in a context...
    }).apply(module,[d3, typeof topojson === "undefined" ? null : topojson]);
